...
from ..types import function_provider_request_retrieve_params
...
from ..types.function_provider_request_retrieve_response import FunctionProviderRequestRetrieveResponse
...
class FunctionProviderRequestsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
    ...
    ) -> FunctionProviderRequestRetrieveResponse:
        """
        Enpoint to retrieve function provider request JSON
        ...
        return self._get(
            ...
            cast_to=FunctionProviderRequestRetrieveResponse,
        )

...
from ..types.openapi_param_parser_retrieve_response import OpenAPIParamParserRetrieveResponse
...
class OpenAPIParamParsersResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
    ...
    ) -> OpenAPIParamParserRetrieveResponse:
        """
        Enpoint to parse OpenAPI doc and extract functions
        ...
        return self._get(
            ...
            cast_to=OpenAPIParamParserRetrieveResponse,
        )

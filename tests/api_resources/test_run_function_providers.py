...
class TestRunFunctionProviders:
    ...
    def test_method_create(self, client: Openplugin) -> None:
        run_function_provider = client.run_function_providers.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",
        )
        assert_matches_type(RunFunctionProviderCreateResponse, run_function_provider, path=["response"])
    ...
    def test_raw_response_create(self, client: Openplugin) -> None:
        response = client.run_function_providers.with_raw_response.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",
    ...
    def test_streaming_response_create(self, client: Openplugin) -> None:
        with client.run_function_providers.with_streaming_response.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",
...
class TestAsyncRunFunctionProviders:
    ...
    async def test_method_create(self, async_client: AsyncOpenplugin) -> None:
        run_function_provider = await async_client.run_function_providers.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",
    ...
    async def test_raw_response_create(self, async_client: AsyncOpenplugin) -> None:
        response = await async_client.run_function_providers.with_raw_response.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",
    ...
    async def test_streaming_response_create(self, async_client: AsyncOpenplugin) -> None:
        async with async_client.run_function_providers.with_streaming_response.create(
            config={},
            function_provider_name="function_provider_name",
            openplugin_manifest_url="openplugin_manifest_url",
            prompt="prompt",

...
from openplugin._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Openplugin | AsyncOpenplugin) -> int:
...
class TestOpenplugin:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "openplugin/_legacy_response.py",
                        "openplugin/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "openplugin/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: Openplugin) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Openplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Openplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Openplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncOpenplugin:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncOpenplugin) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncOpenplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncOpenplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncOpenplugin) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",

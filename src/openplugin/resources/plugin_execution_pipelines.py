...
from ..types import plugin_execution_pipeline_create_params
...
from ..types.plugin_execution_pipeline_create_response import PluginExecutionPipelineCreateResponse
...
class PluginExecutionPipelinesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
    ...
    ) -> PluginExecutionPipelineCreateResponse:
        """
        Enpoint to run a plugin pipeline
        ...
        return self._post(
            ...
            cast_to=PluginExecutionPipelineCreateResponse,
        )
